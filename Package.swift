...
let package = Package(
    ...
    targets: [
        .target(
            ...
            path: "Sources/com.awareframework.ios.sensor.significantmotion"
        ),
        .testTarget(
            name: "com.awareframework.ios.sensor.significantmotionTests",
            dependencies: ["com.awareframework.ios.core", "com.awareframework.ios.sensor.significantmotion"]
        )
    ],
